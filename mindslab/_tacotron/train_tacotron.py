...
def main():
    ...
    parser.add_argument('--data_paths', default=".\\data\\YAF_angry,.\\data\\YAF_sad,.\\data\\YAF_neutral,.\\data\\YAF_pleasant_surprised,.\\data\\YAF_happy,.\\data\\YAF_fear")
    
    
    parser.add_argument('--load_path', default="./logdir-tacotron/YAF_angry+YAF_sad+YAF_neutral+YAF_pleasant_surprised+YAF_happy+YAF_fear_2019-10-02_12-47-08")   # 아래의 'initialize_path'보다 우선 적용
